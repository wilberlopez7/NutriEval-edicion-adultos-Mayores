...
<div id="accordion">
  ...
  <div>
    ...
    <div class="fieldcontain ${hasErrors(bean: pacienteInstance, field: 'telefono', 'error')} required">
      ...
      <g:textField name="telefono" maxlength="13" required="" value="${pacienteInstance?.telefono}"/>  
    </div>
  ...
  <div>
    ...
    <div class="fieldcontain ${hasErrors(bean: pacienteInstance, field: 'circunferenciaCintura', 'error')} required">
      <label for="circunferenciaCintura">
        <g:message code="paciente.circunferenciaCintura.label" default="Circunferencia de Cintura (cm)" />
        <span class="required-indicator">*</span>
      </label>
      <g:field type="number" name="circunferenciaCintura" required="" value="${fieldValue(bean: pacienteInstance, field: 'circunferenciaCintura')}" />
    </div>
    ...
    <div class="fieldcontain ${hasErrors(bean: pacienteInstance, field: 'pesoIdeal', 'error')} required">
     ...
     <br>
    <div align=center><input type="checkbox" name="adultos_complicaciones" value="1" id="adultos_complicaciones">Adulto Con Complicaciones</div>
    </br>
...
$(document).ready(function(){
   $("#adultos_complicaciones").click(function(evento){
      if ($("#adultos_complicaciones").attr("checked")){
