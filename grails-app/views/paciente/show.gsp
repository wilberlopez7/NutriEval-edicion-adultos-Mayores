  ...
  <div id="show-paciente" class="content scaffold-show" role="main">
    ...
    <ol class="property-list paciente">
      ...
      <g:if test="${pacienteInstance?.otrosLiquidos}">
       ...
       <g:if test="${pacienteInstance?.recordatorio}">
        <li class="fieldcontain">
          <span id="recordatorio-label" class="property-label"><g:message code="paciente.recordatorio.label" default="recordatorio" /></span>

          <span class="property-value" aria-labelledby="recordatorio-label"><g:link controller="recordatorio" action="show" id="${pacienteInstance?.recordatorio?.id}">${pacienteInstance?.recordatorio?.encodeAsHTML()}</g:link></span>
